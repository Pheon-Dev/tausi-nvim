...
local function cache_dir()
  local dir = utils.path_join(vim.fn.stdpath('cache'), 'tausi')
  ...
  api.nvim_create_autocmd('BufEnter', {
    callback = function(opt)
      ...
      bufs = vim.tbl_filter(function(k)
        return vim.bo[k].filetype == 'tausi'
      end, bufs)
      if #bufs == 0 then
        self:cache_opts()
    ...
    desc = '[Tausi] clean tausi data reduce memory',
  })
end

-- create tausi instance
